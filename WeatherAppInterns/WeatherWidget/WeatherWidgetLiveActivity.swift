...
struct WeatherWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = WeatherWidgetAttributes(name: "Me")
    static let contentState = WeatherWidgetAttributes.ContentState(value: 3)
