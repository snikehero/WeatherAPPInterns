                        ...
                        VStack (spacing: 10){
                            ...
                            HStack {
                                Button{
                                    ...
                                    Wind(forecasts: $forecastListVM.forecasts)
                                        .modifier(ExtraInfoButton())
                                }
                                Button{
                                    print("Precipitation")
                                    ...
                                    Precipitation(forecasts: $forecastListVM.forecasts)
                                        .modifier(ExtraInfoButton())
                                }
                            }
                            HStack {
                                ...
                                Button{
                                    ...
                                    Humidity(forecasts: $forecastListVM.forecasts)
                                        .modifier(ExtraInfoButton())
                                }
                            }
                            HStack {
                                ...
                                Button{
                                    ...
                                    Pressure(forecasts: $forecastListVM.forecasts)
                                        .modifier(ExtraInfoButton())
                                }
                            }
                        }
